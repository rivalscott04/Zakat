...
#[Fillable(['document_id','status','verification_note','verified_by','verified_at'])] class DocumentVerification extends Model { use BelongsToOrganization,HasUlids; protected function casts():array{return ['verified_at'=>'datetime'];} }
