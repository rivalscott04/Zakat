...
class ReconciliationSession extends Model
{
    ...
    {
        return ['period_start' => 'date', 'period_end' => 'date', 'opening_balance' => 'decimal:2', 'closing_balance' => 'decimal:2', 'matched_amount' => 'decimal:2', 'unmatched_amount' => 'decimal:2', 'difference_amount' => 'decimal:2', 'started_at' => 'datetime', 'completed_at' => 'datetime'];
    }
