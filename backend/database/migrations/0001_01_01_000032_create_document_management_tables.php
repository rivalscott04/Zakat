...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('document_relations', function (Blueprint $table) {
            ...
            $table->string('relation_type', 30)->default('ATTACHMENT');
        ...
        Schema::create('document_access_logs', function (Blueprint $table) {
            ...
            $table->index(['organization_id', 'document_id', 'accessed_at']);
        });
    }

    public function down(): void
    {
        foreach (['document_access_logs', 'document_verifications', 'document_versions', 'document_relations', 'documents'] as $table) {
