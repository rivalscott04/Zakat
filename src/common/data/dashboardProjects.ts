...
const projectsWidgets = [
    {
        id: 1,
        feaIcon: "briefcase",
        feaIconClass: "avatar-title bg-primary-subtle text-primary rounded-2 fs-2",
        label: "Active Projects",
        badgeClass: "badge bg-danger-subtle text-danger fs-12",
    ...
    },
    {
        id: 2,
        feaIcon: "award",
        feaIconClass: "avatar-title bg-warning-subtle text-warning rounded-2 fs-2",
        label: "New Leads",
        badgeClass: "badge bg-success-subtle text-success fs-12",
    ...
    },
    {
        id: 3,
        feaIcon: "clock",
        feaIconClass: "avatar-title bg-info-subtle text-info rounded-2 fs-2",
        label: "Total Hours",
        badgeClass: "badge bg-danger-subtle text-danger fs-12",
        icon: "ri-arrow-down-s-line",
        percentage: "10.35 %",
...
const activeProjects = [
    ...
    },
    {
        ...
        badge: "Pending",
        badgeClass: "danger-subtle text-danger ",
        dueDate: "13 Nov 2021",
    },
    {
        id: 3,
        ...
        badge: "Completed",
        badgeClass: "success-subtle text-success",
        dueDate: "26 Nov 2021",
    },
    {
        id: 4,
...
const projectTasks = [
    {
        ...
        status: "Completed",
        statusClass: "success-subtle text-success",
        img: avatar2,
    },
    {
        id: 2,
        ...
        status: "Progress",
        statusClass: "warning-subtle text-warning",
        img: avatar7,
    },
    {
        id: 3,
    ...
    },
    {
        ...
        status: "Pending",
        statusClass: "danger-subtle text-danger",
        img: avatar5,
    },
    {
        id: 5,
