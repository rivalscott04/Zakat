  ...
  return (
    <div className="min-vh-100 bg-light">
      <nav className="navbar navbar-expand-lg bg-white border-bottom px-4">
        ...
        <div className="navbar-nav gap-2"><Link className="nav-link" to="/muzakis">Muzaki</Link><Link className="nav-link" to="/organizations">Organisasi</Link><Link className="nav-link" to="/amils">Amil</Link><Link className="nav-link" to="/users">User</Link><Link className="nav-link" to="/roles">Role</Link><Link className="nav-link" to="/zakat">Zakat</Link><Link className="nav-link" to="/zakat/calculator">Kalkulator</Link><Link className="nav-link" to="/collections">Collection</Link><Link className="nav-link" to="/funds">Fund</Link></div>
