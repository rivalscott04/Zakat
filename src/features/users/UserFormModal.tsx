...
const UserFormModal = ({ isOpen, user, onClose, onSaved }: Props) => {
  ...
  const validation = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      username: Yup.string()
        .nullable()
        .matches(/^[a-zA-Z0-9_-]*$/, "Username hanya boleh huruf, angka, underscore, atau dash"),
      role_ids: isEdit
        ? Yup.array()
        ...
        <Form onSubmit={validation.handleSubmit}>
          ...
          <div className="row">
            <div className="col-md-6 mb-3">
              <Label htmlFor="username">Username (opsional, untuk login)</Label>
              <Input
                id="username"
                name="username"
                autoComplete="off"
                placeholder="contoh: amil_zetra"
