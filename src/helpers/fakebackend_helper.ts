...
export const updateJobCandidate = (candidate : any) => api.update(url.UPDATE_CANDIDATE + '/' + candidate.id, candidate);
export const deleteJobCandidate = (candidate : any) => api.delete(url.DELETE_CANDIDATE + '/' + candidate);
