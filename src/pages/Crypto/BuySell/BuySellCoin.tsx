                            ...
                            <TabPane tabId="1">
                                <div className="p-3 bg-info-subtle">
                                    <div className="float-end ms-2">
                                        <h6 className="text-info mb-0">USD Balance : <span className="text-body">$12,426.07</span></h6>
                                    </div>
                                    <h6 className="mb-0 text-info">Buy Coin</h6>
                                </div>
                                <div className="p-3">
                                    <Row>
                                        <Col xs-={6}>
                                    ...
                                    <div className="mt-3 pt-2">
                                        <div className="d-flex mb-2">
                                            <div className="flex-grow-1">
                                                <p className="fs-14 mb-0">Transaction Fees<span className="text-muted ms-1 fs-11">(0.05%)</span></p>
                                            </div>
                                        ...
                                        <div className="d-flex mb-2">
                                            <div className="flex-grow-1">
                                                <p className="fs-14 mb-0">Minimum Received<span className="text-muted ms-1 fs-11">(2%)</span></p>
                                            </div>
                                            <div className="flex-shrink-0">
                                    ...
                                    <div className="mt-3 pt-2">
                                        <button type="button" className="btn btn-info w-100">Buy Coin</button>
                                    </div>
                                </div>
                            </TabPane>
