                            ...
                            <table className="table table-nowrap table-centered align-middle">
                                ...
                                <tbody>
                                    {(activeProjects || []).map((item, key) => (<tr key={key}>
                                        ...
                                        <td>
                                            <img src={item.img} className="avatar-xxs rounded-circle me-1" alt="" />  <Link to="#" className="text-reset">{item.projectLead}</Link>
                                        ...
                                        <td><span className={"badge bg-" + item.badgeClass}>{item.badge}</span></td>
