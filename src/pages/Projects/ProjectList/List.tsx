                                            ...
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-shrink-0">
                                                    <div className="d-flex gap-1 align-items-center">
                                                        <button type="button" className={`btn avatar-xs mt-n1 p-0 favourite-btn ${item.ratingClass}`} onClick={(e: any) => activebtn(e.target)}>
                                            ...
                                            <div className="d-flex mb-2">
                                                <div className="flex-shrink-0 me-3">
                                                    <div className="avatar-sm">
                                                        <span className={"avatar-title rounded p-2 bg-" + item.imgbgColor}>
                                                ...
                                                <Row className="gy-3">
                                                    <Col xs={6}>
                                                        <div>
                                                            ...
                                                            <div className={"fs-12 badge bg-" + item.statusClass}>{item.status}</div>
                                                        </div>
                                                    </Col>
                                                    <Col xs={6}>
                                                        <div>
