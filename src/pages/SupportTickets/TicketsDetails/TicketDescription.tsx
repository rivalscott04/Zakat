                        ...
                        <SimpleBar style={{ height: "300px" }} className="px-3 mx-n3">
                            <div className="d-flex mb-4">
                                ...
                                <div className="flex-grow-1 ms-3">
                                    <h5 className="fs-14">Joseph Parker <small className="text-muted">20 Dec 2021 - 05:47AM</small></h5>
                                    ...
                                    <div className="d-flex mt-4">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            <h5 className="fs-14">Alexis Clarke <small className="text-muted">22 Dec 2021 - 02:32PM</small></h5>
                            ...
                            <div className="d-flex">
                                ...
                                <div className="flex-grow-1 ms-3">
                                    ...
                                    <div className="d-flex mt-4">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            <h5 className="fs-14">Donald Palmer <small className="text-muted">8 sec ago</small></h5>
