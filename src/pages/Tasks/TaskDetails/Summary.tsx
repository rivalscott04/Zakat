                    ...
                    <div className="text-muted">
                        ...
                        <div className="pt-3 border-top border-top-dashed mt-4">
                            ...
                            <div className="hstack flex-wrap gap-2 fs-15">
                                <div className="badge fw-semibold bg-info-subtle text-info">UI/UX</div>
                                <div className="badge fw-semibold bg-info-subtle text-info">Dashboard</div>
                                <div className="badge fw-semibold bg-info-subtle text-info">Design</div>
                            </div>
                        </div>
                    </div>
                </CardBody>
