...
const dealsStatus = [
    {
        ...
        badgeClass: "badge bg-primary-subtle text-primary p-2",
        status: "Deal Won",
        statusValue: "$100.1K",
    },
    {
        ...
        badgeClass: "badge bg-warning-subtle text-warning p-2",
        status: "Intro Call",
        statusValue: "$150K",
    },
    {
        ...
        badgeClass: "badge bg-danger-subtle text-danger p-2",
        status: "Stuck",
        statusValue: "$78.18K",
    },
    {
    ...
    },
    {
        ...
        img: avatar6,
        representativeName: "Vitoria Rodrigues",
        badgeClass: "badge bg-info-subtle text-info p-2",
        status: "New Lead",
        statusValue: "$78.9K",
    },
];
...
const tasks = [
    ...
    },
    {
        id: 6,
        forId: "task_six",
        text: "Styling wireframe design and documentation for ZETRA admin",
        date: "27 Sep, 2021",
    },
];
