...
const video = [
    {
        id: 1,
        title: "Admin dashboard templates - Material Design for ZETRA",
        siteLink: "https://zetra.local",
        videoLink: "https://www.youtube.com/embed/GfSZtaoc5bw",
        description: "ZETRA admin is super flexible, powerful, clean, modern & responsive admin template based on bootstrap 5 stable with unlimited possibilities. You can simply change to any layout or mode by changing a couple of lines of code. You can start small and large projects or update design in your existing project using ZETRA it is very quick and easy as it is beautiful, adroit, and delivers the ultimate user experience.",
        likes: 335,
        comments: 102,
        auther: "ZETRA"
    },
    ...
    {
        id: 3,
        title: "ZETRA - The Most Popular Bootstrap 5 HTML, Angular & React Js Admin",
        siteLink: "https://zetra.local",
