...
const projectList = [
    {
        ...
        img: slack,
        imgbgColor: "warning-subtle",
        label: "Slack brand logo design",
        caption: "Create a Brand logo design for a ZETRA admin.",
        number: "18/42",
        progressBar: "34%",
        subItem: [
    ...
    //design 3
    {
        ...
        progressBar: "71%",
        subItem: [
            { id: 1, imgNumber: "T", bgColor: "danger" },
            { id: 2, imgTeam: avatar5 },
            { id: 3, imgNumber: "+" },
        ],
        ratingClass: "active",
