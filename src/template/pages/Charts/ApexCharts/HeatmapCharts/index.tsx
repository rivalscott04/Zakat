...
const HeatmapCharts = () => {
    document.title = "Heatmap Charts | ZETRA";
    return (
        <React.Fragment>
                    ...
                    <Row>
                        ...
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <MultipleHeatmap dataColors='["--vz-primary", "--vz-secondary", "--vz-info", "--vz-success", "--vz-warning", "--vz-danger", "--vz-dark", "--vz-primary", "--vz-card-bg-custom"]'/>
                                </CardBody>
                            </Card>
                        </Col>
