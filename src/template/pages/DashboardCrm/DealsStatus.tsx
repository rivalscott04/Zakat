                                ...
                                <tbody>
                                    {(dealsStatus || []).map((item:any, index:any) => (
                                        <tr key={index}>
                                            <td>{item.name}</td>
                                            <td>{item.date}</td>
                                            <td><img src={item.img} alt="" className="avatar-xs rounded-circle me-2" />  <Link to="#" className="text-body fw-medium">{item.representativeName}</Link></td>
