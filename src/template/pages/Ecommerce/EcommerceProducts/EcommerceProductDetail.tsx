...
import { productDetailsWidgets, reviews } from "../../../data/ecommerce";
                            ...
                            <div>
                              ...
                              <div className="mt-3">
                                <Row className="align-items-center g-2">
                                  ...
                                  <div className="col">
                                    <div className="p-2">
                                      <div className="progress animated-progess bg-success-suble progress-sm">
                                        <div
                                ...
                                <Row className="align-items-center g-2">
                                  ...
                                  <div className="col">
                                    <div className="p-2">
                                      <div className="progress animated-progess bg-success-subtle progress-sm">
                                        <div
                                          className="progress-bar bg-success"
                                          role="progressbar"
                                          style={{ width: "19.32%" }}
                                ...
                                <Row className="align-items-center g-2">
                                  ...
                                  <div className="col">
                                    <div className="p-2">
                                      <div className="progress bg-warning-subtle animated-progess progress-sm">
                                        <div
                                          className="progress-bar bg-success"
                                          role="progressbar"
                                          style={{ width: "18.12%" }}
                                ...
                                <Row className="align-items-center g-2">
                                  ...
                                  <div className="col">
                                    <div className="p-2">
                                      <div className="progress bg-success-subtle animated-progess progress-sm">
                                        <div
                                          className="progress-bar bg-success"
                                          role="progressbar"
                                          style={{ width: "7.42%" }}
                                ...
                                <Row className="align-items-center g-2">
                                  ...
                                  <div className="col">
                                    <div className="p-2">
                                      <div className="progress bg-danger-subtle animated-progess progress-sm">
                                        <div
