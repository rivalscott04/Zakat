...
const FileManager = () => {
    document.title = "File Manager | ZETRA";
                                                    ...
                                                    <tr key={key}>
                                                        ...
                                                        <td>
                                                            <div className="d-flex gap-3 justify-content-center">
                                                                <button type="button" className="btn btn-ghost-primary btn-icon btn-sm favourite-btn" onClick={(e: any) => favouriteBtn(e.target)}>
                                                    ...
                                                    <table className="table table-borderless table-nowrap table-sm">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td className="share-path">ZETRA:\Documents\</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
