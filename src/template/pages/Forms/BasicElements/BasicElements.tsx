...
import { Card, CardBody, Col, Container, DropdownItem, DropdownMenu, DropdownToggle, Input, Label, Row, UncontrolledDropdown, FormGroup } from "reactstrap";
import PreviewCardHeader from "../../../../shared/components/Common/PreviewCardHeader";


const BasicElements = () => {
    document.title = "Basic Elements | ZETRA";
    return (
        <React.Fragment>
            <UiContent />
