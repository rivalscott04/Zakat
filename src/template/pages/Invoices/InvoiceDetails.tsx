...
const InvoiceDetails = () => {
  document.title = "Invoice Details | ZETRA";
  //Print the Invoice
  const printInvoice = () => {
    window.print();
  };
                    ...
                    <CardHeader className="border-bottom-dashed p-4">
                      <div className="d-flex">
                        ...
                        <div className="flex-shrink-0 mt-sm-0 mt-3">
                          ...
                          <h6><span className="text-muted fw-normal">Email:</span><span id="email">ZETRA@themesbrand.com</span></h6>
                  ...
                  <Col lg={12}>
                    <CardBody className="p-4">
                      ...
                      <div className="border-top border-top-dashed mt-2">
                        <table className="table table-borderless table-nowrap align-middle mb-0 ms-auto" style={{ width: "250px" }}>
                          <tbody>
                            ...
                            <tr>
                              <td>Discount <small className="text-muted">(ZETRA15)</small></td>
                      ...
                      <div className="hstack gap-2 justify-content-end d-print-none mt-4">
                        <Link to="#" className="btn btn-info" onClick={printInvoice}><i className="ri-printer-line align-bottom me-1"></i> Print</Link>
