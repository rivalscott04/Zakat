...
import { jobList } from "../../../../data/appsJobs";
...
const JobList = () => {
  ...
  document.title = "Job Lists | ZETRA";
  return (
    <React.Fragment>
                    ...
                    <Col xxl={2} ms={6}>
                      <div className="input-light">
                        <select
                          ...
                          defaultValue="Newest"
                        >
                          <option value="All" defaultValue="All">All Selected</option>
                          <option value="Newest">
                            Newest
                          </option>
            ...
            <Col xxl={3}>
              ...
              >
                ...
                <CardBody className="card-body">
                  ...
                  <div className="mt-3">
                    <h5 className="view-title fs-18">Product Designer</h5>
                    <div className="hstack gap-3 mb-3">
                      <span className="text-muted">
                        <i className="ri-building-line me-1 align-bottom"></i>{" "}
                        <span className="view-companyname">ZETRA</span>
                      </span>
                      <span className="text-muted">
...
//                           <button
//                             type="button"
//                             className={favouritebtn ? "btn btn-ghost-primary btn-icon custom-toggle active" : "btn btn-ghost-primary btn-icon custom-toggle" }
//                             data-bs-toggle="button"
...
//                         <Col lg={4} sm={6}>
//                           <div>
//                             <p className="mb-2 text-uppercase fw-medium fs-12 text-muted">
//                               Job Type
//                             </p>
//                             <h5 className="fs-14 mb-0 view-type">Full Time</h5>
//                           </div>
