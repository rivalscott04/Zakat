...
import { discoverItemsData } from "../../../data";
                                    ...
                                    <CardBody>
                                        <div className="d-flex align-items-center mb-3">
                                            ...
                                            <div className="bookmark-icon">
                                                <button type="button" className={item.isIcon ? "btn btn-icon" : "btn btn-icon active"} data-bs-toggle="button" aria-pressed="true" onClick={(e:any) => favouriteBtn(e.target)}>
