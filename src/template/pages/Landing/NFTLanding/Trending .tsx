                                            ...
                                            <CardBody>
                                                <Row className="g-1 mb-3">
                                                    <Col lg={6}>
                                                        ...
                                                        <img src="/assets/demo/nft-2.jpg" alt="" className="img-fluid rounded mt-1" />
                                                    </Col>
                                                    <Col lg={6}>
                                                        <img src="/assets/demo/nft-5.jpg" alt="" className="img-fluid rounded mb-1" />
                                            ...
                                            <CardBody>
                                                <Row className="g-1 mb-3">
                                                    <Col lg={6}>
                                                        ...
                                                        <img src="/assets/demo/nft-1.jpg" alt="" className="img-fluid rounded mt-1" />
                                                    </Col>
                                                    <Col lg={6}>
                                                        <img src="/assets/demo/nft-4.png" alt="" className="img-fluid rounded mb-1" />
                                            ...
                                            <CardBody>
                                                <Row className="g-1 mb-3">
                                                    <Col lg={6}>
                                                        ...
                                                        <img src="/assets/demo/nft-3.jpg" alt="" className="img-fluid rounded mt-1" />
                                                    </Col>
                                                    <Col lg={6}>
                                                        <img src="/assets/demo/nft-1.jpg" alt="" className="img-fluid rounded mb-1" />
                                        ...
                                        <Card>
                                            <CardBody>
                                                <Row className="g-1 mb-3">
                                                    <Col lg={6}>
                                                        <img src={Img03} alt="" className="img-fluid rounded" />
                                                        <img src="/assets/demo/nft-5.jpg" alt="" className="img-fluid rounded mt-1" />
                                                    </Col>
                                                    <Col lg={6}>
                                                        <img src="/assets/demo/nft-2.jpg" alt="" className="img-fluid rounded mb-1" />
                                                        <img src={Img05} alt="" className="img-fluid rounded" />
                                                    </Col>
                                                </Row>
                                                <Link to="#!" className="float-end"> View All <i className="ri-arrow-right-line align-bottom"></i></Link>
