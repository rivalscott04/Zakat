...
import { expolreNow } from "../../../data/index";

const ExploreNow = () => {
    document.title = "Explore Now | ZETRA";
    ...
    const category = (e:any) => {
        setNFTList(
            expolreNow.filter((item:any) => item.category === e));
    };

    const fileType = (e:any) => {
        setNFTList(
            expolreNow.filter((item:any) => item.fileType === e));
    };

    const salesType = (e:any) => {
        setNFTList(
            expolreNow.filter((item:any) => item.sales === e));
    };
