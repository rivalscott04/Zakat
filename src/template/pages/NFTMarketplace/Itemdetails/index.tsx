...
const ItemDetails = () => {
    document.title = "Item Details | ZETRA";
                                        ...
                                        <Card className="ribbon-box border shadow-none right">
                                            ...
                                            <div className="position-absolute bottom-0 p-3">
                                                ...
                                                <Row className="justify-content-center">
                                                    ...
                                                    <Col className="col-3">
                                                        <img src="/assets/demo/nft-3.jpg" alt="" className="img-fluid rounded h-100 object-fit-cover" />
                                                    </Col>
                                                    <Col className="col-3">
                                                        ...
                                                        <table className="table align-middle table-nowrap mb-0">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div className="d-flex align-items-center">
                                                                            <img src="/assets/demo/nft-4.png" alt="" className="avatar-xs rounded object-fit-cover" />
