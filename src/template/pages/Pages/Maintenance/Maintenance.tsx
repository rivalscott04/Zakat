...
import ParticlesAuth from "../../../template/pages/AuthenticationInner/ParticlesAuth";

//images import
import maintenanceImg from "../../../assets/images/maintenance.png";

const Maintenance = () => {
    document.title = "Maintenance | ZETRA";
    return (
        <React.Fragment>
            <ParticlesAuth>
                                ...
                                <div className="text-center mt-sm-5 pt-4">
                                    <div className="mb-5 text-white-50">
                                        ...
                                        <div className="mt-4 pt-2">
                                            <Link to="/" className="btn btn-info"><i className="mdi mdi-home me-1"></i> Back to Home</Link>
                                        </div>
                                    </div>
