...
const SimplePage = () => {
    ...
    const [activityTab, setActivityTab] = useState<any>('1');
                                ...
                                <div className="p-2">
                                    ...
                                    <div className="hstack text-white-50 gap-1">
                                        <div className="me-2"><i
                                            ...
                                            United States</div>
                                        <div><i
                                            className="ri-building-line me-1 text-white text-opacity-75 fs-16 align-middle"></i>ZETRA
                                        </div>
                                    </div>
                                </div>
                            </Col>
                                                            ...
                                                            <Table className="table-borderless mb-0">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td className="text-muted">support@zetra.local</td>
                                                                    </tr>
                                                                    <tr>
                                                            ...
                                                            <Col xs={6} md={4}>
                                                                <div className="d-flex mt-4">
                                                                    ...
                                                                    <div className="flex-grow-1 overflow-hidden">
                                                                        ...
                                                                        <Link to="#" className="fw-semibold">www.zetra.local</Link>
                                                                    </div>
                                                                </div>
                                                            </Col>
                                                        </Row>
                                                ...
                                                <div className="acitivity-timeline">
                                                    ...
                                                    <div className="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div className="flex-grow-1 ms-3">
                                                            ...
                                                            <p className="text-muted mb-2">added a new member to ZETRA
                                                                dashboard</p>
                                                                            ...
                                                                            <td>
                                                                                <div className="d-flex align-items-center">
                                                                                    ...
                                                                                    <div className="ms-3 flex-grow-1">
                                                                                        <h6 className="fs-15 mb-0"><Link to="#" className="text-body">{item.fileName}</Link>
                                                                                        </h6>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
