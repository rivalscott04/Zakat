                                ...
                                <div className="timeline">
                                    ...
                                    <div className="timeline-item left">
                                        ...
                                        <div className="content">
                                            ...
                                            <p className="text-muted">Every team project can have a shared workspace. Use ZETRA to share information with your team to understand and contribute to your project.</p>
                                    ...
                                    <div className="timeline-item left">
                                        ...
                                        <div className="content">
                                            <h5>ZETRA admin dashboard templates layout upload</h5>
                                    ...
                                    <div className="timeline-continue">
                                        ...
                                        <Row className="timeline-right">
                                            ...
                                            <Col xs={12}>
                                                <div className="timeline-box">
                                                    <div className="timeline-text">
                                                        <h5>ZETRA - Project Discussion</h5>
