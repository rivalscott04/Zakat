                                ...
                                <Row className="mb-3">
                                    <div className="col-md">
                                        <Row className="align-items-center g-3">
                                            ...
                                            <div className="col-md">
                                                <div>
                                                    <h4 className="fw-bold">ZETRA - Admin & Dashboard</h4>
                                                    <div className="hstack gap-3 flex-wrap">
                                                        <div><i className="ri-building-line align-bottom me-1"></i> ZETRA</div>
                                                        <div className="vr"></div>
                                                        <div>Create Date : <span className="fw-semibold">15 Sep, 2021</span></div>
                                                        <div className="vr"></div>
                                                        <div>Due Date : <span className="fw-semibold">29 Dec, 2021</span></div>
                                                        <div className="vr"></div>
