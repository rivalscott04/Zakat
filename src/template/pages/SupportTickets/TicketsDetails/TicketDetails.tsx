                    ...
                    <CardBody>
                        <div className="table-responsive table-card">
                            <Table className="table-borderless align-middle mb-0">
                                <tbody>
                                    <tr>
                                        <td className="fw-semibold">Ticket</td>
                                        <td>#VLZ<span id="t-no">135</span></td>
                                    </tr>
                                    <tr>
                                        <td className="fw-semibold">Client</td>
                                        <td id="t-client">ZETRA</td>
                                    </tr>
                                    <tr>
                                        <td className="fw-semibold">Project</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select className="form-select" id="t-status" data-choices data-choices-search-false aria-label="Default select example">
                                                <option value="Stauts">Stauts</option>
                                    ...
                                    <tr>
                                        <td className="fw-semibold">Create Date</td>
                                    ...
                                    <tr>
                                        <td className="fw-semibold">Labels</td>
                    ...
                    <CardBody>
                        <div className="d-flex align-items-center border border-dashed p-2 rounded">
                            ...
                            <div className="flex-grow-1 ms-3">
                                <h6 className="mb-1"><Link to="#">ZETRA-admin.zip</Link></h6>
                        ...
                        <div className="d-flex  align-items-center border border-dashed p-2 rounded mt-2">
                            ...
                            <div className="flex-grow-1 ms-3">
                                <h6 className="mb-1"><Link to="#">ZETRA-admin.ppt</Link></h6>
