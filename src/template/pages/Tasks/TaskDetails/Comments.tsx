                            ...
                            <SimpleBar style={{ height: "508px" }} className="px-3 mx-n3 mb-2">
                                <div className="d-flex mb-4">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        <h5 className="fs-14"><Link to="/pages-profile" className="text-body">Joseph Parker</Link> <small className="text-muted">20 Dec 2021 - 05:47AM</small></h5>
                                        ...
                                        <div className="d-flex mt-4">
                                            ...
                                            <div className="flex-grow-1 ms-3">
                                                <h5 className="fs-14"><Link to="/pages-profile" className="text-body">Tonya Noble</Link> <small className="text-muted">22 Dec 2021 - 02:32PM</small></h5>
                                ...
                                <div className="d-flex mb-4">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        <h5 className="fs-14"><Link to="/pages-profile" className="text-body">Thomas Taylor</Link> <small className="text-muted">24 Dec 2021 - 05:20PM</small></h5>
                                ...
                                <div className="d-flex">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        <h5 className="fs-14"><Link to="/pages-profile" className="text-body">Tonya Noble</Link> <small className="text-muted">26 min ago</small></h5>
                                        ...
                                        <div className="d-flex mt-4">
                                            ...
                                            <div className="flex-grow-1 ms-3">
                                                <h5 className="fs-14"><Link to="/pages-profile">Nancy Martino</Link> <small className="text-muted">8 sec ago</small></h5>
                            ...
                            <form className="mt-4">
                                <Row className="g-3">
                                    ...
                                    <Col xs={12} className="text-end">
                                        <button type="button" className="btn btn-ghost-info btn-icon waves-effect me-1"><i className="ri-attachment-line fs-16"></i></button>{" "}
                                        ...
                                        <tr>
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="ms-3 flex-grow-1">
                                                        <h6 className="fs-15 mb-0"><Link to="#">ZETRA admin.ppt</Link></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>PPT File</td>
