            ...
            <Card>
                <CardBody className="text-center">
                    ...
                    <div className="hstack gap-2 justify-content-center">
                        <button className="btn btn-info btn-sm"><i className="ri-stop-circle-line align-bottom me-1"></i> Stop</button>
                ...
                <CardBody>
                    ...
                    <div className="table-card">
                        <table className="table mb-0">
                            <tbody>
                                <tr>
                                    <td className="fw-semibold">Tasks No</td>
                                    <td>#VLZ456</td>
                                </tr>
                                <tr>
                                    <td className="fw-semibold">Tasks Title</td>
                                    <td>Profile Page Structure</td>
                                </tr>
                                <tr>
                                    <td className="fw-semibold">Project Name</td>
                                    <td>ZETRA - Admin Dashboard</td>
                                </tr>
                                <tr>
                    ...
                    <div className="vstack gap-2">
                        ...
                        <div className="border rounded border-dashed p-2">
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1 overflow-hidden">
                                    <h5 className="fs-14 mb-1"><Link to="#" className="text-body text-truncate d-block">ZETRA admin.ppt</Link></h5>
                        ...
                        <div className="border rounded border-dashed p-2">
                            <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1 overflow-hidden">
                                    <h5 className="fs-14 mb-1"><Link to="#" className="text-body text-truncate d-block">Images.zip</Link></h5>
