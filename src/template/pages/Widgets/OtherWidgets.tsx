...
import { otherWidgets2 } from "../../data/index";
...
import { widgets } from "../../data/appsJobs";
            ...
            <Row>
                ...
                <Col xl={4}>
                    <Card className="bg-primary">
                        <CardBody className="p-0">
                            <Alert color="info" className="rounded-top alert-solid alert-label-icon border-0 rounded-0 m-0 d-flex align-items-center">
