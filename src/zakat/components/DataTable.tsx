...
/**
 * Tabel dengan paginasi sisi server. Velzon TableContainer dan Pagination
 * keduanya memuat seluruh dataset di client, sedangkan API Zakat OS wajib
 * berpaginasi (PRD 00 §23), jadi bagian paginasinya ditangani di sini.
 * Markup dan kelasnya tetap memakai gaya Velzon.
 */
